        ...
        <div className='ctn-servicios'>
          <div className='nuestros-servicios'>
            ...
            <p className='text-transition'>
              Identificamos oportunidades de mejora y te ayudamos a hacer crecer tu negocio ¿Sentís
              que tu marca no despega? En CALU analizamos la situación actual y diseñamos una
              estrategia de comunicación para definir la identidad digital de tu marca y mejorar tus
              resultados. Nuestro modelo de trabajo se basa en la cercanía con las personas para
              sumar valor y lograr que sus negocios despeguen. ¡Empecemos a trabajar en equipo!
            </p>
          </div>
          <div className='nuestros-servicios'>
            <Card
            ...
            <p className='text-transition'>
              ...
              un plan de contenidos para mejorar la presencia digital de tu marca, darle más alcance
              y aumentar tus ventas. ¡Dale vida a tus redes y destacate de la competencia!
            </p>
          </div>
          <div className='nuestros-servicios'>
            <Card
            ...
            <p className='text-transition'>
              ...
              efectivas Creamos tus campañas de publicidad, en Google ADS, Meta ADS, LinkedIn Ads y
              TikTok Ads con anuncios altamente personalizados y segmentados, para dirigirlos a un
              público que realmente se interese en tus productos o servicios. Medimos las métricas
              de las campañas y realizamos los ajustes necesarios para obtener mejores resultados.
              ¡Incrementá tu presencia online, dejá tu huella y que más personas te conozcan!
            </p>
          </div>
        </div>
      </section>
